...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Unity/godot-tenten-project-main/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=D:/Unity/godot-tenten-project-main/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/Unity/godot-tenten-project-main/.claude/commands/gsd
AGENTS_DIR=D:/Unity/godot-tenten-project-main/.claude/agents
```
...
<execution_context>
Surface state file: `D:/Unity/godot-tenten-project-main/.claude/skills/.gsd-surface.json`
Install profile marker: `D:/Unity/godot-tenten-project-main/.claude/skills/.gsd-profile`
Engine module: `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
