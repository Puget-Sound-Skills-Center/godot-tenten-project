...
<!-- For checkpoint task examples and patterns, see @D:/Unity/godot-tenten-project-main/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
