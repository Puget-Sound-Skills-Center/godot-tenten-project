...
- Usage: Reference from command with `@D:/Unity/godot-tenten-project-main/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Unity/godot-tenten-project-main/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Unity/godot-tenten-project-main/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
