...
See D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/discovery.md
...
Use D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/discovery.md.
