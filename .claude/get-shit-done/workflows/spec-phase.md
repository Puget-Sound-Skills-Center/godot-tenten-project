...
```bash
INIT=$(node "D:/Unity/godot-tenten-project/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Unity/godot-tenten-project/.claude/get-shit-done/templates/spec.md.
