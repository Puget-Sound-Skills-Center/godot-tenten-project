...
```
Agent(
  prompt="Read D:/Unity/godot-tenten-project/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Unity/godot-tenten-project/.claude/get-shit-done/templates/VALIDATION.md`
