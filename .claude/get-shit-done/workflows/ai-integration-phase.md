...
<required_reading>
@D:/Unity/godot-tenten-project/.claude/get-shit-done/references/ai-frameworks.md
...
```markdown
Read D:/Unity/godot-tenten-project/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Unity/godot-tenten-project/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Unity/godot-tenten-project/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Unity/godot-tenten-project/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Unity/godot-tenten-project/.claude/agents/gsd-eval-planner.md for instructions.
