...
INSTALL_JS_GLOBAL="D:/Unity/godot-tenten-project/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Unity/godot-tenten-project/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
