...
```bash
INIT=$(node "D:/Unity/godot-tenten-project/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/Unity/godot-tenten-project/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
