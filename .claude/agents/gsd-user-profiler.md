...
<reference>
@D:/Unity/godot-tenten-project-main/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/references/user-profiling.md` to load:
