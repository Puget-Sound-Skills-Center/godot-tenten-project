...
@D:/Unity/godot-tenten-project-main/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/Unity/godot-tenten-project-main/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
