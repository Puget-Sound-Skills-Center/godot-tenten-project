...
Use template from `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/UI-SPEC.md`
