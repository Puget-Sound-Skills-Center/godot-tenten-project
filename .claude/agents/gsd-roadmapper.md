...
Reference full template: `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Unity/godot-tenten-project-main/.claude/get-shit-done/templates/state.md`.
